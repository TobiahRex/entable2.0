    ...
    <div className="informationContainer">
      <div className="infoHowItWorks col-sm-6">
        ...
        <div className="information">
          ...
          <h6>Visitors can browse banks,
          follow impact and donate directly to bankers using m-pesa</h6>
        </div>
        <div className="information">
          <div className="num">
            3
          </div>
          <h6>Bankers gather once per month to borrow &
          lend at rates and amounts of their choosing</h6>
        </div>
        <div className="information">
          <div className="num">
            4
